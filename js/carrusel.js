...
window.addEventListener('DOMContentLoaded', () => {
  const contenedor = document.querySelector('.vistas');
  const slides = document.querySelectorAll('.vistas-img');
  const prevBtn = document.querySelector('.prev');
  const nextBtn = document.querySelector('.next');
  const section = document.querySelector('.personajes'); // para pausar al hover
