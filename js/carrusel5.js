...
window.addEventListener('DOMContentLoaded', () => {
  const contenedor = document.querySelector('.promo');
  const slides = document.querySelectorAll('.promo-img');
  const prevBtn = document.querySelector('.prev5');
  const nextBtn = document.querySelector('.next5');
  const section = document.querySelector('.promocionales'); // para pausar al hover
