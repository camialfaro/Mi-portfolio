...
window.addEventListener('DOMContentLoaded', () => {
  const contenedor = document.querySelector('.publi');
  const slides = document.querySelectorAll('.publi-img');
  const prevBtn = document.querySelector('.prev6');
  const nextBtn = document.querySelector('.next6');
  const section = document.querySelector('.publicidad'); // para pausar al hover
