...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const slides = document.querySelectorAll('.logo-img');
  const prevBtn = document.querySelector('.prev7');
  const nextBtn = document.querySelector('.next7');
  const section = document.querySelector('.logo'); // para pausar al hover
